...
void _serverLog(const char* message, const char* function, int logLevel, AsyncWebServerRequest *request) {
...
void _setHtmlPages() {
    ...
    server.on("/", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get index page", "customserver::_setHtmlPages::/", CUSTOM_LOG_LEVEL_DEBUG, request);
        request->send_P(200, "text/html", index_html);
    });

    server.on("/configuration", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get configuration page", "customserver::_setHtmlPages::/configuration", CUSTOM_LOG_LEVEL_DEBUG, request);
        request->send_P(200, "text/html", configuration_html);
    });

    server.on("/calibration", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get calibration page", "customserver::_setHtmlPages::/calibration", CUSTOM_LOG_LEVEL_DEBUG, request);
        request->send_P(200, "text/html", calibration_html);
    });

    server.on("/channel", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get channel page", "customserver::_setHtmlPages::/channel", CUSTOM_LOG_LEVEL_DEBUG, request);
        request->send_P(200, "text/html", channel_html);
    });

    server.on("/info", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get info page", "customserver::_setHtmlPages::/info", CUSTOM_LOG_LEVEL_DEBUG, request);
        request->send_P(200, "text/html", info_html);
    });

    server.on("/update-successful", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get update successful page", "customserver::_setHtmlPages::/update-successful", CUSTOM_LOG_LEVEL_DEBUG, request);
        request->send_P(200, "text/html", update_successful_html);
    });

    // CSS
    server.on("/css/main.css", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get custom CSS", "customserver::_setHtmlPages::/css/style.css", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/images/favicon.png", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get favicon", "customserver::_setHtmlPages::/favicon.ico", CUSTOM_LOG_LEVEL_DEBUG, request);
...
void _setOta() {
    ...
    _serverLog("Request to get update page", "customserver::_setOta::/update", CUSTOM_LOG_LEVEL_DEBUG, request);
...
void _setRestApi() {
    server.on("/rest/is-alive", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to check if the ESP32 is alive", "customserver::_setRestApi::/rest/is-alive", CUSTOM_LOG_LEVEL_DEBUG, request);

        request->send(200, "application/json", "{\"message\":\"True\"}");
    });

    server.on("/rest/device-info", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get device info from REST API", "customserver::_setRestApi::/rest/device-info", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/rest/wifi-info", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get WiFi values from REST API", "customserver::_setRestApi::/rest/wifi-info", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/rest/meter", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get meter values from REST API", "customserver::_setRestApi::/rest/meter", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/rest/meter-single", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get meter values from REST API", "customserver::_setRestApi::/rest/meter-single", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/rest/active-power", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get meter values from REST API", "customserver::_setRestApi::/rest/active-power", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/rest/get-ade7953-configuration", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get ADE7953 configuration from REST API", "customserver::_setRestApi::/rest/get-ade7953-configuration", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/rest/get-channel", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get channel data from REST API", "customserver::_setRestApi::/rest/get-channel", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/rest/get-calibration", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get configuration from REST API", "customserver::_setRestApi::/rest/get-calibration", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/rest/calibration-reset", HTTP_POST, [&](AsyncWebServerRequest *request) {
        _serverLog("Request to reset calibration values from REST API", "customserver::_setRestApi::/rest/calibration-reset", CUSTOM_LOG_LEVEL_WARNING, request);
    ...
    server.on("/rest/reset-energy", HTTP_POST, [](AsyncWebServerRequest *request) {
        _serverLog("Request to reset energy counters from REST API", "customserver::_setRestApi::/rest/reset-energy", CUSTOM_LOG_LEVEL_WARNING, request);
    ...
    server.on("/rest/get-log-level", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get log level from REST API", "customserver::_setRestApi::/rest/get-log-level", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/rest/get-general-configuration", HTTP_GET, [](AsyncWebServerRequest *request) {
        _serverLog("Request to get get general configuration from REST API", "customserver::_setRestApi::/rest/get-general-configuration", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/rest/clear-log", HTTP_POST, [](AsyncWebServerRequest *request) {
        _serverLog("Request to clear log from REST API", "customserver::_setRestApi::/rest/clear-log", CUSTOM_LOG_LEVEL_DEBUG, request);
    ...
    server.on("/rest/restart", HTTP_POST, [](AsyncWebServerRequest *request) {
        _serverLog("Request to restart the ESP32 from REST API", "customserver::_setRestApi::/rest/restart", CUSTOM_LOG_LEVEL_WARNING, request);
    ...
    server.on("/rest/reset-wifi", HTTP_POST, [](AsyncWebServerRequest *request) {
        _serverLog("Request to erase WiFi credentials from REST API", "customserver::_setRestApi::/rest/reset-wifi", CUSTOM_LOG_LEVEL_WARNING, request);
    ...
    server.onRequestBody([](AsyncWebServerRequest *request, uint8_t *data, size_t len, size_t index, size_t total){
        ...
        if (request->url() == "/rest/set-calibration") {   
            _serverLog("Request to set calibration values from REST API (POST)", "customserver::_setRestApi::onRequestBody::/rest/set-calibration", CUSTOM_LOG_LEVEL_INFO, request);
            ...
            _serverLog("Request to set ADE7953 configuration from REST API (POST)", "customserver::_setRestApi::onRequestBody::/rest/set-ade7953-configuration", CUSTOM_LOG_LEVEL_INFO, request);
            ...
            _serverLog("Request to set general configuration from REST API (POST)", "customserver::_setRestApi::onRequestBody::/rest/set-general-configuration", CUSTOM_LOG_LEVEL_INFO, request);
