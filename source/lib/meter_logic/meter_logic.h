...
// ============================================================================
// A single RSTIRQSTATA read can OR multiple causes into one snapshot (IRQ pin is
// level-active-low, ESP32 interrupt is edge-triggered, so causes co-pend). True
