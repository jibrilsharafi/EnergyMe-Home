...
| --- | --- |
| Open the box and identify the parts ([§1](01-installation.md#1-whats-in-the-box)) | Anything inside the electrical panel ([§3](01-installation.md#3-electrical-installation)) |
| Configure Wi-Fi and the web interface ([§4](02-setup.md#4-software-configuration)) | Switching off the main breaker |
| Map circuits to channels in the UI ([§4.5](02-setup.md#45-configure-each-channel)) | Connecting L / N to the device |
