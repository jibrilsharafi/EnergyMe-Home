...
- New Home Pro v1.0 hardware profile: 74HC4067 with 11 wired channels + direct ADE7953 input = 12 channels; W5500 pins on a dedicated SPI bus; pinout to be filled in when hardware arrives.
